...
- `platform/id`: `generateUuidV7` (decision D7, RFC 9562, SPIKE-03) for time-ordered primary keys; not yet wired into any table — see `docs/implementation/spikes/SPIKE-03/migration-plan.md` for the phased adoption plan.
