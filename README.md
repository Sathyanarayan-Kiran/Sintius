...
- The Phase 0 active-tenant proof command owns an RLS-protected proof record and publishes `foundation.proof_recorded.v1`. Concurrent PostgreSQL retries prove one mutation/audit/outbox/stored response, correlation propagation and tenant-B read/replay isolation. Real RBAC composition, dispatcher/trace evidence and the CI release gate remain.
