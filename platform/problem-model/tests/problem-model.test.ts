...
test("TC-001-05-01 the problem catalog is a stable published contract", () => {
  const golden: ReadonlyArray<readonly [string, number, string]> = [
    ...
    ["unknown_permission", 500, "Unknown permission"],
    ["role_not_found", 404, "Role not found"],
    ["role_assignment_exists", 409, "Role assignment exists"],
    ["role_assignment_not_found", 404, "Role assignment not found"],
    ["separation_of_duties_violation", 403, "Separation of duties violation"],
    ["approval_policy_not_found", 404, "Approval policy not found"],
    ["approval_not_found", 404, "Approval not found"],
    ["approval_not_pending", 409, "Approval not pending"],
